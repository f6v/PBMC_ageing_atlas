...
qc_cutoffs = pd.DataFrame(
  {
    ...
    'total_counts_min': [1000, 1000, 2000, 2000, 2000, 1000, 1000, 1000, 1000, 1500, 1500, 1500],
    'total_counts_max': [10000, 12000, 22000, 20000, 17000, 10000, 12000, 10000, 10000, 12000, 12000, 10000],
    'pct_counts_mt_min': [7, 7, 8, 10, 9, 7, 7, 7, 7, 7, 6, 7],
    'pct_counts_mt_max': [7, 7, 8, 10, 9, 7, 7, 7, 7, 7, 6, 7],
  }
)
