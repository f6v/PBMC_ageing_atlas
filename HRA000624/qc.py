...
qc_cutoffs = pd.DataFrame(
  {
    ...
    'total_counts_min': [1000, 1000, 1000, 1200, 800, 1500, 1500, 1200, 1500, 1000, 1200, 1500, 1500, 1500, 1200, 1200, 1200, 1200, 1500, 1500],
    'total_counts_max': [8000, 8000, 8000, 8000, 6000, 9000, 9000, 9000, 10000, 10000, 10000, 10000, 10000, 10000, 8000, 9000, 7000, 8000, 10000, 10000],
    'pct_counts_mt_min': [11, 10, 10, 9, 14, 10, 9, 10, 10, 8, 9, 9, 9, 9, 10, 10, 10, 11, 9, 9],
    'pct_counts_mt_max': [11, 10, 10, 9, 14, 10, 9, 10, 10, 8, 9, 9, 9, 9, 10, 10, 10, 11, 9, 9]
  }
)
